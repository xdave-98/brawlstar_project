...
class FlattenedBattleData(BaseModel):
    ...
    battle_duration: int = Field(alias="battleDuration", description="Battle duration in seconds")
    ...
    brawler_trophies: int = Field(alias="brawlerTrophies", description="Brawler trophies")
    
    # Team info
    team_size: int = Field(alias="teamSize", description="Team size")
    opponent_count: int = Field(alias="opponentCount", description="Number of opponents")
    is_star_player: bool = Field(alias="isStarPlayer", description="Whether player was star player")
...
def create_flattened_battle_data(raw_data: dict, player_tag: str) -> List[FlattenedBattleData]:
    """
